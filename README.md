[![Build Status](https://travis-ci.org/opspec-pkgs/azure.sql.server.firewallrule.create.svg?branch=master)](https://travis-ci.org/opspec-pkgs/azure.sql.server.firewallrule.create)
